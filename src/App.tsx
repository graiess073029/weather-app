      ...
      <div className={`root_inner ${theme}`}>
        ...
        >
          ...
          <div className="input">
            <div className="search">
              ...
              <button disabled={place.length === 0 || !navigator.onLine} className="animated" onClick={searchHandler}>
                Search
              </button>
              <button className="location animated" onClick={getCurrentPos} >
                <Location />
        ...
        >
          <div className="daily">
            ...
            <div className="cards">
              <Card title="feels like" value={weatherCardsData.apparent_temperature} />
              <Card title="humidity" value={weatherCardsData.humidity} />
              <Card title="wind" value={weatherCardsData.wind} />
              <Card title="precipitation" value={weatherCardsData.precipitation} />
            </div>
            <div className="cards">
              ...
              <Card title="Precipitation %" value={weatherCardsData.precipitationProbability} />
            </div>
            <DailyForecast />
          </div>
          <HourlyForecast
